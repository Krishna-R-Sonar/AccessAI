...
// Middleware
app.use(cors({
 origin: 'https://access-ai-iota.vercel.app', // Update this to match your frontend URL
 methods: ['GET', 'POST'],
...
const authenticateToken = (req, res, next) => {
 ...
 if (!token) return next(); // Allow unauthenticated requests to proceed (e.g., for non-logged-in chat)
